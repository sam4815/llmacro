...
* [`src/llmacro/`](src/llmacro/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/llmacro/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `llmacro` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/llmacro/config.cljs) defaults to `true` in
...
```clj
(ns llmacro.example
  (:require [llmacro.config :as config])
